...
# For Azure Machine Learning Platform
...
def main(args):
    ...
    while lr > args.min_lr and epoch_itr.next_epoch_idx <= max_epoch:
        # train for one epoch
        valid_losses, should_stop = train(args, trainer, task, epoch_itr, aml_run)
        if should_stop:
            break
...
def train(args, trainer, task, epoch_itr, aml_run):
...
def validate(args, trainer, task, epoch_itr, subsets, aml_run = None):

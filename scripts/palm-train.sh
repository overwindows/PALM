...
CUDA_VISIBLE_DEVICES=1 python -m utils.train "$data_bin" \
    ...
    --skip-invalid-size-inputs-valid-test --validate-interval 1 --eval-bleu --max-tokens-valid 4096 \
    ...
    --wandb-project PALM \
    --save-dir /bigdata/palm_cnn_dm_checkpoints --tensorboard-logdir /bigdata/logdir/palm_cnn_dm
